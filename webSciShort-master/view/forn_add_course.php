      ...
      <div class="col-md-8">
        <form name="frmadd" method="post" action="../controller/con_add_course.php" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            <label for="staticEmail" class="col-sm-2 col-form-label">พ.ศ.</label>
            <div class="col-sm-10">
            ...
            <!-- <div class="form-group row">
              <label for="cars" class="col-sm-2 col-form-label">เลือกปี</label>
              <div class="col-sm-10">
                <input type="text" name="cs_year" class="form-control" id="cs_year" placeholder="ปี">
              </div>
            </div> -->

            <!--ปีในการค้นหา-->
            <!-- <select class="form-select" id="cs_year" name="cs_year">
             /////<?php
             /////$obj_name = new Course();
